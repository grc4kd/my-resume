...
+ 'about multiple software layers. This type of developer can typically be found delving deeply into a few subjects at a '
+ 'time, while also prioritizing total business value above specific implementation details. However, this doesn\'t mean '
+ 'that they aren\'t aware of the risks and benefits of clean code. On the contrary, sometimes their most pressing '
+ 'responsibility is deciding where to expend the most effort and discipline.'
        }
    },
    {
